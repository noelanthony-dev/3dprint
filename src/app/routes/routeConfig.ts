...
export const appRoutes = [
  {
    description: "Startup page with lightweight operational snapshots.",
    id: "dashboard",
    label: "Dashboard",
    path: "/",
    Page: DashboardPage,
  ...
  {
    description: "Filament stock, color, TD, and low-stock tracking.",
  ...
  {
    description: "Production run logging and estimated stock movement.",
    id: "production",
    label: "Production",
    path: "/production",
  ...
  {
    description: "On-demand monthly sales, expense, production, and profit summaries.",
    id: "reports",
    label: "Reports",
    path: "/reports",
  ...
  {
    description: "Manual and generated procurement planning.",
    id: "shopping-list",
    label: "Shopping List",
    path: "/shopping-list",
  ...
  {
    description: "Local app settings for costing and HueForge defaults.",
    id: "settings",
    label: "Settings",
    path: "/settings",
    Page: SettingsPage,
  ...
  {
    description: "Manual backup, export, import, and restore workflows.",
    id: "backup",
    label: "Backup",
    path: "/backup",
    Page: BackupPage,
